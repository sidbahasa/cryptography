...
// 770b80259ec33beb2561358a9f2dc617e46218c0a53cbeca695ae45faa8952aa0e311bde9d4e01726d3184c34451
   ...
   public static void myQuestion4(){
     ...
     * @param string A string with length = a whole number multiple of blockSize
     * @param blockSize The number of char in a block.
     ...
     * @param hexKey The AES key in hex
     * @return 
     */
     ...
     * @param cipherText The CBC encrypted cipher text to decrypt.
     * @param encryptedIv The encrypted iv.
     * @param aesKey The AES key in hex
     */
    public static void decryptCBC(String cipherText, String encryptedIv, String aesKey){
        ...
        try{
            ...
            CipherInputStream cipherInputStream = new CipherInputStream(inStream, aesCipher);
     ...
     * @param cipherText The CTR encrypted cipher text to decrypt.
     * @param encryptedIv The encrypted iv.
     * @param aesKey The AES key in hex
     */
     ...
     * </ul>
     * @param aesKey The AES key in hex
     * @param cipherText The cipher text includes the encrypted iv.
     */
    public static void myDecryptCBC(String aesKey, String cipherText)
    {
        ...
        String[] encryptedBlocks = 
                splitStringIntoBlocks(cipherText, 32);
        System.out.println("Decrypting...");
     ...
     * </ul>
     * @param aesKey The AES key in hex
     * @param cipherText The cipher text includes the plain text iv.
     */
     ...
     * @param one A potentially padded byte array
     * @param two The other byte array
     * @param pad true if the first byte array is padded; false otherwise
